...
// hourly btn
const hourlyData = [
    { time: "Now", icon: "/weather-icons/weather/clear-sky.png", temperature: "65&deg;" },
    { time: "2 hours", icon: "/weather-icons/weather/rain.png", temperature: "68&deg;" },
    { time: "4 hours", icon: "/weather-icons/weather/rainy.png", temperature: "55&deg;" },
    { time: "6 hours", icon: "/weather-icons/weather/snow.png", temperature: "45&deg;" },
    { time: "8 hours", icon: "/weather-icons/weather/sunny.png", temperature: "70&deg;" }
];
...
const forecastData = [
    { day: "Now", icon: "/weather-icons/weather/clear-sky.png", temperature: "65&deg;" },
    { day: "Monday", icon: "/weather-icons/weather/rain.png", temperature: "68&deg;" },
    { day: "Tuesday", icon: "/weather-icons/weather/rainy.png", temperature: "55&deg;" },
    { day: "Wednesday", icon: "/weather-icons/weather/snow.png", temperature: "45&deg;" },
    { day: "Thursday", icon: "/weather-icons/weather/sunny.png", temperature: "70&deg;" },
    { day: "Friday", icon: "/weather-icons/weather/sunny.png", temperature: "70&deg;" },
    { day: "Saturday", icon: "/weather-icons/weather/sunny.png", temperature: "70&deg;" },
    { day: "Sunday", icon: "/weather-icons/weather/sunny.png", temperature: "70&deg;" }
];
